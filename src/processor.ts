...
const DEFAULT_FILTER="0x163df34fccbf003ce219d3f1d9e70d140b60622cb9dd47599c25fb2f797ba6e::liquidity_pool::SwapEvent"
  ...
  processTransactions({
    ...
    for (const transaction of transactions) {
      ...
      const objects = events.map((event, i) => {
        if (event.typeStr!.includes(DEFAULT_FILTER)) {
